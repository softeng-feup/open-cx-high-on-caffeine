...
import 'session_pageSpeaker.dart';

class ConferencePageSpeaker extends StatefulWidget {
  ConferencePageSpeaker({Key key, this.auth, this.userId, this.mode}) : super(key: key);
  ...
  @override
  State<StatefulWidget> createState() => new _ConferencePageSpeakerState(mode: mode);
}

class _ConferencePageSpeakerState extends State<ConferencePageSpeaker> {
 _ConferencePageSpeakerState({this.mode});
